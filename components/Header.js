...
const Header = ({ headerData, navData }) => {
  ...
  return (
    <header
      ...
      } fixed  w-full left-0 right-0 mx-auto max-w-[90vw]
   lg:max-w-[1120px] z-20 flex justify-between items-center transition-all duration-500`}
    >
      <Link href="/">
        <a>
          <Image src={`${header ? logoImgV2 : logoImgV1}`} alt="" width={header ? 180 : 212} height={50} />
        </a>
      </Link>
