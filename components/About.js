      ...
      <div className="container mx-auto">
        ...
        >
          <motion.div variants={fadeInDown} className="flex-1 mt-[74px]">
            ...
            <div
              className="bg-accent/10 border-l-[10px] border-accent max-w-[570px] h-[160px]
             flex items-center justify-center mb-8 lg:mb-0"
            >
              <p
                className="text-[20px] leading-normal lg:text-[24px] lg:leading-[32px] 
          ...
          <motion.div variants={fadeInUp} className="flex-1">
            <Image src={boyImg} alt="" width={575} height={480} />
          </motion.div>
        </motion.div>
      </div>
    </section>
